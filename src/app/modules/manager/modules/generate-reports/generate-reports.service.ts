...
constructor(private http: HttpClient) { }
  ...
  public GenerateTenderReport(dto: GenerateReportDTO) : Observable<boolean> {
    return this.http.post<any>(`${environment.integrationApiUrl}/EquipmentTender/report`, dto);
  }
}
